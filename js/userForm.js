function saveUser(user) {
    ...
    // build json object
    let data = {
        identification : $("#identificationUser").val(), // user.id
        name : $("#nameUser").val(), // user.name
        adress : $("#addressUser").val(), // user.adress
        cellphone : $("#cellphone").val(), // user.cellphone
        email : $("#emailUser").val(), // user.email
